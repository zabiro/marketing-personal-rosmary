...
class CargasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carga" do
    assert_difference('Carga.count') do
      post cargas_url, params: { carga: { campana: @carga.campana, fecha: @carga.fecha, placa: @carga.placa } }
    end
  ...
  test "should update carga" do
    patch carga_url(@carga), params: { carga: { campana: @carga.campana, fecha: @carga.fecha, placa: @carga.placa } }
